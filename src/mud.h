 ...
 * SMAUG Version -- Scryn
 */
#define SMAUG_VERSION_MAJOR "0"
#define SMAUG_VERSION_MINOR "6a"
...
struct morph_data
{
   ...
   short saving_fortitude; /* Below are saving adjusted */
   short saving_reflex;
   short saving_will;
...
typedef enum
{
   ...
   CON_GET_NEW_RACE, CON_CONFIRM_NEW_RACE, CON_GET_DRYAD_SUBRACE,
   CON_GET_NEW_CLASS, CON_CONFIRM_NEW_CLASS, CON_GET_NEW_SEX,
   CON_GET_AGE, CON_CONFIRM_AGE, CON_GET_SKILLS, CON_CONFIRM_SKILLS,
   CON_GET_EMULATION, CON_READ_MOTD,
   CON_GET_STATS, CON_CONFIRM_STATS, CON_TITLE, CON_PRESS_ENTER,
...
typedef enum
{
   ...
   SUB_WRITING_NOTE,	SUB_MPROG_EDIT,  	SUB_HELP_EDIT, 			SUB_WRITING_MAP,
   SUB_PERSONAL_BIO, 	SUB_REPEATCMD,		SUB_RESTRICTED, 		SUB_DEITYDESC,
   SUB_MORPH_DESC, 		SUB_MORPH_HELP,		SUB_PROJ_DESC, 			SUB_NEWS_POST,
   SUB_NEWS_EDIT,
   /*
...
typedef enum
{
   RACE_HUMAN, RACE_DWARF, RACE_ELF, RACE_HALF_ELF, RACE_GNOME, RACE_CATFOLK,
   RACE_WOLFFOLK, RACE_CYCLOPS, RACE_FIREBIRD, RACE_BENN, RACE_MERFOLK, RACE_NAGA,
   RACE_DRYAD, RACE_NAIAD, RACE_LIZARDFOLK, RACE_DOLLFOLK, RACE_FAIRY, RACE_SATYR,
   RACE_MINOTAUR, RACE_CENTAUR, RACE_SPHINX, RACE_SALAMANDER, RACE_GRYPHON, RACE_DRAGON,
   RACE_UNICORN, RACE_SLIME
} race_types;


/*
 *  Updated to the 14 classes we'll be using - Danny
 */
#define CLASS_NONE	   			-1   /* For skill/spells according to guild */
#define CLASS_BARD	    		0
#define CLASS_CHEVALIER	    	1
#define CLASS_CLERIC	   		2
#define CLASS_DRUID		    	3
#define CLASS_ELEMENTALIST  	4
#define CLASS_ENCHANTER	   		5
#define CLASS_ILLUSIONIST   	6
#define CLASS_LANCER	    	7
#define CLASS_MONK		   		8
#define CLASS_PALADIN	   	 	9
#define CLASS_RANGER	   		10
#define CLASS_ROGUE		   		11
#define CLASS_SCHOLAR      		12
#define CLASS_WARRIOR      		13


/*
 * Subrace definitions - Danny
 */
#define SUBRACE_NONE			0
#define SUBRACE_CACTUS_DRYAD	1
#define SUBRACE_SUCCULENT_DRYAD	2
#define SUBRACE_TREE_DRYAD		3


/*
 * Subclass definitions - Danny
 */
#define SUBCLASS_NONE			0
#define SUBCLASS_FIRE			1
#define SUBCLASS_WATER			2
#define SUBCLASS_AIR			3
#define SUBCLASS_EARTH			4
#define SUBCLASS_LIFE			5
#define SUBCLASS_DARKNESS		6
#define SUBCLASS_SOUND			7
#define SUBCLASS_SIGHT			8
#define SUBCLASS_SMELL			9
#define SUBCLASS_TOUCH			10
#define SUBCLASS_CHARM			11
#define SUBCLASS_GLAMOUR		12
#define SUBCLASS_ENHANCEMENT	13
#define SUBCLASS_CREATION		14
#define SUBCLASS_GROWTH			15
#define SUBCLASS_TIME			16
#define SUBCLASS_WEATHER		17
#define SUBCLASS_MAX			18


/*
 * Skill rank definitions - Danny
 */
#define RANK_UNSKILLED			0
#define RANK_DILETTANTE			1
#define RANK_DISCIPLE			12
#define RANK_PRACTITIONER		23
#define RANK_ARTISAN			34
#define RANK_ADEPT				45
#define RANK_PROFESSIONAL		56
#define RANK_SAVANT				67
#define RANK_EXPERT				78
#define RANK_VIRTUOSO			89
#define RANK_PARAMOUNT			100


/*
 * Age category definitions - Danny
 */
#define AGE_CHILD				0
#define AGE_YOUTH				1
#define AGE_ADULT				2
#define AGE_MIDDLE				3
#define AGE_ELDERLY				4


/*
 * Languages - Danny
 */
#define LANG_COLISTANI		    BV00 /* Colista Regional Language, Colistani Humans */
#define LANG_CAOLIDAN		    BV01 /* Elves from Colista */
#define LANG_DORISH	 	        BV02 /* Dori Regional Language, Dorish Humans  */
#define LANG_DARDI       		BV03 /* Elves from Dori */
#define LANG_LAVANDAI		    BV04 /* Lavada Regional Language, Lavandai Humans */
#define LANG_VALAO			  	BV05 /* Elves from Lavada */
#define LANG_FTAGHN			    BV06 /* Ancient Dwarven */
#define LANG_FAHN	   			BV07 /* Modern Dwarven */
#define LANG_VAOLUMIN      		BV08 /* Gnomes */
#define LANG_CHYA     			BV09 /* Catfolk */
#define LANG_FENRADYA      		BV10 /* Wolffolk */
#define LANG_SIRU			   	BV11 /* Firebirds, Unicorns, Ancient Magic Language */
#define LANG_SOLESE     		BV12 /* Dryads, Naiads, Dragons, Modern Magic Language */
#define LANG_RUSSA     			BV13 /* Firebirds */
#define LANG_WOLOF         		BV14 /* Benn */
#define LANG_CORUSTENYA     	BV15 /* Cyclops */
#define LANG_SIMGH    			BV16 /* Gryphons, Benn */
#define LANG_ASKRAVAARDI	    BV17 /* Merfolk, Salamanders, Naiads */
#define LANG_GREGA	     		BV18 /* Naga, Lizardfolk, Dragons */
#define LANG_WILDTONGUE       	BV19 /* Dryads, Unicorns */
#define LANG_YRANIB				BV20 /* Dollfolk */
#define LANG_MIJ				BV21 /* Fairies */
#define LANG_SAULOON			BV22 /* Satyrs, Slimes */
#define LANG_VEDRIC				BV23 /* Minotaurs, Centaurs, Sphinxes */

#define LANG_UNKNOWN        	0 /* Anything that doesnt fit a category */
#define VALID_LANGS    			( LANG_COLISTANI | LANG_CAOLIDAN | LANG_DORISH | LANG_DARDI \
...
struct class_type
{
   ...
   int race_restriction;	/* Flags for illegal races	*/
};
...
typedef enum
{
   ...
   AFF_FLYING, AFF_PASS_DOOR, AFF_FLOATING, AFF_TRUESIGHT, AFF_DARKVISION, AFF_DETECTTRAPS,
...
#define RIS_AIR		  				BV02
#define RIS_EARTH		  			BV03
#define RIS_LIFE	  				BV04
#define RIS_DARKNESS	  			BV05
#define RIS_BLUNT		  			BV06
#define RIS_PIERCE	  				BV07
#define RIS_SLASH		  			BV08
#define RIS_POISON		  			BV09
...
typedef enum
{
   ...
   DFND_VENOMSHIELD, DFND_BLOCK, MAX_DEFENSE_TYPE
} defense_types;
...
typedef enum
{ SS_NONE, SS_FORTITUDE, SS_REFLEX, SS_WILL
} save_types;
...
typedef enum
{ SD_NONE, SD_FIRE, SD_WATER, SD_AIR, SD_EARTH, SD_LIFE,
   SD_DARKNESS, SD_POISON
} spell_dam_types;
...
#define OBJ_VNUM_PILE_OF_STICKS		27
...
#define OBJ_VNUM_WOOD               67
#define OBJ_VNUM_WOODFIRE           68
...
typedef enum
{
   ...
   ITEM_TINDER, ITEM_LOCKPICK, ITEM_SPIKE, ITEM_DISEASE, ITEM_OIL, ITEM_FLINT,
   ...
   ITEM_MEAT, ITEM_PLANT, ITEM_HAMMER, ITEM_INGOT, ITEM_AXE, ITEM_WOOD,
   ITEM_FISH, ITEM_FISHINGPOLE, ITEM_DRINK_MIX
} item_types;
...
typedef enum
{
   ...
   ITEM_MULTI_INVOKE, ITEM_ENCHANTED, ITEM_TINY, ITEM_TWOHANDED, MAX_ITEM_FLAG
} item_extra_flags;
...
#define ITEM_WEAR_ANKLES			BV21
#define ITEM_WEAR_TAIL      		BV22
#define ITEM_WEAR_HOOVES    		BV23
#define ITEM_WEAR_LIMBS     		BV24
...
typedef enum
{
   ...
   APPLY_HITROLL, APPLY_DAMROLL, APPLY_SAVING_FORTITUDE, APPLY_SAVING_REFLEX, APPLY_SAVING_WILL,
...
#define ROOM_VNUM_TEMPLE	  		8020
#define ROOM_VNUM_ALTAR		  		8020
#define ROOM_VNUM_SCHOOL	  		8101
#define ROOM_AUTH_START		    	100
#define ROOM_VNUM_HALLOFFALLEN 		21195
#define ROOM_VNUM_PVP        		3009
...
typedef enum
{
   ...
   ROOM_PROTOTYPE, ROOM_DND, ROOM_BFS_MARK, ROOM_TINY, ROOM_FORGE, ROOM_MAX
} room_flags;
...
typedef enum
{
   ...
   SECT_OCEAN, SECT_OCEANFLOOR, SECT_UNDERGROUND, SECT_LAVA, SECT_SWAMP, SECT_ICE,
   SECT_MAX
} sector_types;
...
typedef enum
{
   WEAR_NONE = -1, WEAR_FACE = 0, WEAR_HEAD, WEAR_EYES, WEAR_EARS, WEAR_NECK,
   WEAR_ABOUT, WEAR_BODY, WEAR_BACK, WEAR_WAIST, WEAR_ARMS, WEAR_FORE_LEGS,
   WEAR_HANDS, WEAR_FORE_ANKLES, WEAR_WRIST_L, WEAR_WRIST_R, WEAR_FINGER_L,
   WEAR_FINGER_R, WEAR_LEGS, WEAR_HIND_LEGS, WEAR_FEET, WEAR_TAIL,
   WEAR_HOOVES, WEAR_HIND_ANKLES, WEAR_HOLD, WEAR_WIELD, WEAR_DUAL_WIELD,
   WEAR_SHIELD, WEAR_MISSILE_WIELD, MAX_WEAR
} wear_locations;
...
typedef enum
{
   ...
   PLR_MOUNTED, PLR_MOUNTABLE, PLR_HASLEGS, PLR_RESETMSG
} player_flags;

/* Bits for pc_data->flags. */
#define PCFLAG_R1              		BV00
#define PCFLAG_PVP	        		BV01
...
#define PCFLAG_PRIVACY		   		BV17  /* Added by Samson 6-11-99 Finger privacy */
  /*
...
/*
 * Sitting on objects - Danny Aug/12
 */
#define SIT_NONE   					BV00
#define SIT_ON     					BV01
#define SIT_IN     					BV02
#define SIT_AT     					BV03
#define STAND_ON   					BV04
#define STAND_IN   					BV05
#define STAND_AT   					BV06
#define SLEEP_ON   					BV07
#define SLEEP_IN   					BV08
...
struct char_data
{
   ...
   int bodyshape;
   OBJ_DATA *on; /* What are they sitting on? */
};
...
struct pc_data
{
   ...
   int flags;  /* Whether the player is a pvper and whatever else we add.      */
   ...
   char *aim;   /* AIM SN for finger - Danny */
...
typedef enum
{
   WEP_BAREHAND, WEP_SWORD, WEP_DAGGER, WEP_WHIP, WEP_POLEARM, WEP_MACE,
...
struct skill_type
{
   ...
   short attribute;  			/* Relevant attribute - Str/Dex/Con/Int/Wis/Cha/Lck */
...
extern short gsn_study; /* For Scholars */
...
extern short gsn_flight; /* for do_land  */
...
/* Updated language gsns -Danny */
extern short gsn_colistani;
extern short gsn_caolidan;
extern short gsn_dorish;
extern short gsn_dardi;
extern short gsn_lavandai;
extern short gsn_valao;
extern short gsn_ancient_dwarven;
extern short gsn_dwarven;
extern short gsn_gnomish;
extern short gsn_chya;
extern short gsn_fenradya;
extern short gsn_ancient_magical;
extern short gsn_magical;
extern short gsn_russa;
extern short gsn_wolof;
extern short gsn_ancient_human;
extern short gsn_simgh;
extern short gsn_askravaardi;
extern short gsn_grega;
extern short gsn_wildtongue;
extern short gsn_yranib;
extern short gsn_mij;
extern short gsn_sauloon;
extern short gsn_vedric;
...
#define CAN_CAST(ch)			( (ch)->Class != 1 && (ch)->Class != 7 (ch)->Class != 11 && (ch)->Class != 13 ) /* Not used currently */

#define IS_VAMPIRE(ch)			( !IS_NPC(ch) && (ch)->Class==14 )
...
#define GET_DAMROLL(ch)			( (ch)->damroll +(ch)->damplus +str_app[get_curr_str(ch)].todam +(((ch)->mental_state > 5 &&(ch)->mental_state < 15) ? 1 : 0) )

#define IS_OUTSIDE(ch)			( !xIS_SET( (ch)->in_room->room_flags, ROOM_INDOORS ) && !xIS_SET( (ch)->in_room->room_flags, ROOM_TUNNEL) )

#define NO_WEATHER_SECT(sect)  	( sect == SECT_INSIDE || sect == SECT_UNDERWATER || sect == SECT_OCEANFLOOR || sect == SECT_UNDERGROUND )
...
#define IS_PVPCLAN(ch)    		( !IS_NPC( (ch) )                                  \
                				&& (ch)->pcdata->clan                              \
...
#define IS_PKILL(ch)            ( (ch)->pcdata && IS_SET( (ch)->pcdata->flags, PCFLAG_PVP ) )

#define CAN_PKILL(ch)           ( IS_PKILL( (ch) ) && (ch)->level >= 5 )

#define WAIT_STATE(ch, npulse) 	( (ch)->wait=( !IS_NPC(ch) )? UMAX( (ch)->wait, npulse ) : UMAX( (ch)->wait, npulse) )
...
#define IS_AIR(dt)				( IS_VALID_SN(dt) && SPELL_DAMAGE(skill_table[(dt)]) == SD_AIR )
#define IS_EARTH(dt)			( IS_VALID_SN(dt) && SPELL_DAMAGE(skill_table[(dt)]) == SD_EARTH )
#define IS_LIFE(dt)				( IS_VALID_SN(dt) && SPELL_DAMAGE(skill_table[(dt)]) == SD_LIFE )
#define IS_DARKNESS(dt)			( IS_VALID_SN(dt) && SPELL_DAMAGE(skill_table[(dt)]) == SD_DARKNESS )
...
extern const char *const body_shape[];
...
DECLARE_DO_FUN( do_pvp );
DECLARE_DO_FUN( do_pvpflag );
...
#define BOUNTY_LIST     		"bounty.lst" /* Bounty system stuff */
...
void show_body_line( CHAR_DATA * ch, CHAR_DATA * victim );
const char *get_skill_rank args( ( short percentage ) );
...
/* bounty.c */
BOUNTY_DATA *get_disintigration args( ( const char *target ) );
...
const char *get_subclass args( ( int subclass ) );
...
bool saves_fortitude( int level, CHAR_DATA * victim );
bool saves_reflex( int level, CHAR_DATA * victim );
bool saves_will( int level, CHAR_DATA * victim );
ch_ret obj_cast_spell( int sn, int level, CHAR_DATA * ch, CHAR_DATA * victim, OBJ_DATA * obj );
int dice_parse( CHAR_DATA *ch, int level, const char *texp, CHAR_DATA *victim, int sn );
...
typedef enum
{
   ...
   USE_PROG, SELL_PROG, TELL_PROG, CMD_PROG, COMMAND_PROG
} prog_types;
...
signed int prog_command_trigger( CHAR_DATA* ch, const char *command, bool bExact );
